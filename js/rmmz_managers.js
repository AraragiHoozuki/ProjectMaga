...
DataManager._databaseFiles = [
    ...
    { name: "$dataPLC", src: "JSONPlayerChars.json"},
    { name: "$dataENC", src: "JSONEnemyChars.json"},
    { name: "$dataEnemySets", src: "EnemySets.json"},
    { name: "$dataClasses", src: "JSONClasses.json" },
    { name: "$dataSkills", src: "JSONSkills.json" },
 ...
 *
 * @param {Object} bgm
 * @param {string} bgm.name
 * @param {number} bgm.pitch - 100
 * @param {number} bgm.volume - 100
 */
 ...
 *
 * @param {Object} se
 * @param {string} se.name
 * @param {number} se.pitch
 * @param {number} se.volume
 */
